...
- **紅線 49**:**Response > 2000 chars 必須先列 outline, 唔好 3000+ chars 嘅單一 response**(2026-06-07 完工, evidence: 過去 24h 39% response > 3000 chars, 90-percentile 6171 chars, 最高 34827 chars)。理由: David 明確投訴「不斷出詳細」係 verbose 唔係 zombie。規則: (1) Response 開始時 1-3 個 emoji bullet 列 outline, 畀用戶睇到 scope; (2) Detail 部分如果 < 2000 chars 就 inline, > 2000 chars 就開 sub-section 折疊; (3) 唔好 repeat 解釋同一個 concept; (4) Default 用 markdown list, 唔用 paragraph。例外: Build 階段嘅 detail code block / file content 唔算 response chars。
