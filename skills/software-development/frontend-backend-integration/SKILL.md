...
### Observed drift cases (<project> 2026-06)
...
- **Plan doc ≠ wire shape** — Plan may say `defaultTaxRate`, backend says `rate`. Always grep the backend route file before committing the client wrapper. (<project> Day 14.7 Step 7 caught this at code-review time before any PUT was sent; runtime would have 400'd on a Zod validation error.)
