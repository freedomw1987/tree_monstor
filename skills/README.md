...
| [`react-router-v7-patterns`](frontend/react-router-v7-patterns/SKILL.md) | React Router v7 patterns and pitfalls for nested-route SPA refactors. Class-level lessons from 2026-06-07 <project> Day 14.7 (Settings tabs): URL as source of… |
