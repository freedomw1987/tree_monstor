...
|---|---|---|
| `logEvent` API field-name drift in callers | [`logevent-api-field-name-drift.md`](references/pitfalls/logevent-api-field-name-drift.md) | <project>, 2026-06-07 (pre-existing) |
| RBAC seed coverage gap | [`rbac-seed-coverage-gap.md`](references/pitfalls/rbac-seed-coverage-gap.md) | <project>, 2026-06-07 (CRITICAL) |
| Derive pure helpers from inline route logic for unit tests | [`pure-function-derive-from-inline-route-logic.md`](references/pitfalls/pure-function-derive-from-inline-route-logic.md) | <project> Sprint 1, 2026-06-08 |
| `Record<EnumType, ...>` map vs backend emit drift | [`record-enumtype-map-backend-emit-drift.md`](references/pitfalls/record-enumtype-map-backend-emit-drift.md) | <project> audit, 2026-06-06 |
| Plan wording vs backend wire shape | [`plan-doc-wording-vs-backend-wire-shape.md`](references/pitfalls/plan-doc-wording-vs-backend-wire-shape.md) | <project> Day 14.7, 2026-06-07 |
| Form refactor silently regresses working state | [`form-refactor-silent-regression.md`](references/pitfalls/form-refactor-silent-regression.md) | <project>, 2026-06-08 |
| Source-check test when ESM mocking is unreliable | [`source-check-regression-test.md`](references/pitfalls/source-check-regression-test.md) | <project> Sprint 4 RG-007, 2026-06-09 |
| External package / binary spec assumption | [`external-spec-assumption.md`](references/pitfalls/external-spec-assumption.md) | <project> Sprint 21, 2026-06-16 |
| A “remove X” fix that leaves references behind | [`fix-naming-not-actually-removed.md`](references/pitfalls/fix-naming-not-actually-removed.md) | <project> RG-007 cleanup gap, 2026-06-09 |
| Permanent cache for admin-mutable state | [`permanent-cache-anti-pattern.md`](references/pitfalls/permanent-cache-anti-pattern.md) | <project> Sprint 4 RG-007, 2026-06-09 |
| User committed overlapping work first | [`user-committed-before-you.md`](references/pitfalls/user-committed-before-you.md) | <project> Day 10 doc sync, 2026-06-09 |
| Token trust / fake UUID privilege escalation | [`token-trust-fake-uuid-privilege-escalation.md`](references/pitfalls/token-trust-fake-uuid-privilege-escalation.md) | <project> TD-011, 2026-06-08 |
| Reproduce and trace a 500 before writing a fix | [`reproduce-before-fix-500.md`](references/pitfalls/reproduce-before-fix-500.md) | <project> TD-011, 2026-06-08 |
| Eight-file documentation sync pattern | [`eight-doc-files-sync-pattern.md`](references/pitfalls/eight-doc-files-sync-pattern.md) | <project>, 2026-06-07 |
| Verify the next blocker after a surface fix | [`verify-next-blocker-after-surface-symptom.md`](references/pitfalls/verify-next-blocker-after-surface-symptom.md) | <project> Sprint 5, 2026-06-09 |
